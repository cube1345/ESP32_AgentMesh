...
const timeline: TimelineEvent[] = [
  {
    time: '09:14:02',
    stage: 'tool_use',
    source: 'esp32s3-coordinator-01',
    target: 'control_agent',
    payload: 'tool_use mesh_send_command',
    status: 'ok',
    eventId: 'evt-coordinator-01',
    nodeId: 'esp32s3-coordinator-01',
    role: 'coordinator_agent',
    phase: 'reasoning',
    traceId: 'trace-demo-001',
    taskId: 'task-cmd-status-light-01',
    commandId: 'cmd-status-light-01',
    action: 'set_status_light',
    targetRole: 'control_agent',
    tsMs: 1760001242000
  },
  {
    time: '09:14:03',
    ...
    source: 'esp32s3-coordinator-01',
    target: 'control_agent',
    payload: 'dispatch set_status_light blue',
    status: 'ok',
    eventId: 'evt-coordinator-02',
    nodeId: 'esp32s3-coordinator-01',
    role: 'coordinator_agent',
    phase: 'dispatch',
    traceId: 'trace-demo-001',
  ...
  },
  {
    ...
    stage: 'policy_check',
    source: 'esp32s3-coordinator-01',
    target: 'guardian_agent',
    payload: '请求执行单次动作: set_status_light blue',
    status: 'queued',
    eventId: 'evt-guardian-01',
    nodeId: 'esp32s3-guardian-01',
    role: 'guardian_agent',
    phase: 'policy',
    traceId: 'trace-demo-001',
    taskId: 'task-cmd-status-light-01',
  ...
  },
  {
    ...
    source: 'esp32s3-guardian-01',
    target: 'control_agent',
    payload: 'allow, risk_score=0.32, privacy_mode=metadata_only',
    status: 'ok',
    eventId: 'evt-guardian-02',
    nodeId: 'esp32s3-guardian-01',
    role: 'guardian_agent',
    phase: 'policy',
    traceId: 'trace-demo-001',
  ...
  { time: '09:14:04', stage: 'sandbox_denied', source: 'tool_registry', target: 'write_file', payload: 'sandbox denied write_file: skill changes require explicit confirmed=true', status: 'warn', eventId: 'evt-sandbox-01', phase: 'policy', tsMs: 1760001244700 },
  { time: '09:14:05', stage: 'telemetry_publish', source: 'sensor_agent', target: 'MQTT Mesh', payload: 'temp=27.4C humidity=64.2% tvoc=21ppb lux=185', status: 'ok', eventId: 'evt-sensor-telemetry-01', nodeId: 'esp32s3-sensor-01', role: 'sensor_agent', phase: 'sensor', tsMs: 1760001245000 },
  {
    time: '09:14:06',
    stage: 'tool_result',
    source: 'esp32s3-control-01',
    target: 'WS2812',
    payload: 'set_status_light(color=blue)',
    status: 'ok',
    eventId: 'evt-control-01',
    nodeId: 'esp32s3-control-01',
    role: 'control_agent',
    phase: 'execution',
    traceId: 'trace-demo-001',
    taskId: 'task-cmd-status-light-01',
  ...
  },
  {
    ...
    source: 'esp32s3-coordinator-01',
    target: 'Feishu',
    payload: '好的，已经将状态灯切换为蓝色。',
    status: 'ok',
    eventId: 'evt-coordinator-03',
    nodeId: 'esp32s3-coordinator-01',
    role: 'coordinator_agent',
    phase: 'final',
    traceId: 'trace-demo-001',
